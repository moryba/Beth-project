---
title: "Machine learning on real cybersecurity data"
author: "Jamel Belgacem - Papa Moryba Kouate"
date: "`r Sys.Date()`"
output:
  pdf_document:
    toc: true
...
\end{figure}
   ...
   - **Prediction**\
      ...
      **Model 1** seems to predict only the "unsuspicious" class and fails to detect any "suspicious" activities, resulting in poor performance for identifying suspicious activities.
        ...
        ![Model 1 Confusion matrix](pics/Dense_confusionmatrix.png){width=30%, height=30%}
\newpage
...
\end{figure}
   ...
   - **Prediction**\
      **Model 2** shows a strong ability to correctly identify suspicious activities while maintaining a low false positive rate.
      ...
      ![Model 2 Confusion matrix](pics/Dense2_confusionmatrix.png){width=30%, height=30%}
\newpage
...
\newpage
  ...
  ![Model 9 accuracy and loss](pics/LSTM-model3-training.png){width=40%, height=40%}
...
# Discussion
   ...
   - Model Suitability: Dense models without embeddings and LSTM models in the shapelet discovery method underperform, indicating that they may require additional tuning or may not be suitable for this specific task.
